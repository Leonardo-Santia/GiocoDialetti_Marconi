document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = [
    { 
      text: "Qual è la traduzione corretta?", 
      choices: [
        "Alla rocca piove e nevica. Quando finalmente c'è bel tempo, il vento la porta via.", 
        "Sulla roccia piove e nevica. Una volta che arriva il bel tempo, il vento rimedia ai danni", 
        "La rocca: piove e nevica. Quando c'è bel tempo, il vento la fa risplendere"
      ], 
      correct: 0 
    },
    { 
      text: "Se il vento ha tirato:", 
      choices: ["Martino esce", "Martino rientra", "Martino è rientrato"], 
      correct: 2 
    },
    { 
      text: "Di che si sta parlando?", 
      choices: ["Di un dente", "Di un raccolto", "Di un tetto"], 
      correct: 0
    }
  ];
  ...
  function showFinalScore() {
    ...
    if (score >= 3) {
      reaction = "COMPLIMENTI, 3 su 3! Sei gavignanese?";
    } else if (score == 2) {
      reaction = "Non male, ma non sei davvero del posto!";
    } else {
      reaction = "Il gavignanese non fa per te...";
    }
