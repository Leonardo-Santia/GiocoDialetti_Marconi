document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = [
    { 
      text: "Cosa dice?", 
      choices: [
        "Segni: Chiacchiere e castagne", 
        "Segni: Chi viene, vuole restarci", 
        "Segni: Il re ha molti castelli"
      ], 
      correct: 0 
    },
    { 
      text: "Cosa succede quando piove?", 
      choices: ["Le mucche si preparano alla maggese", "Il bestiame si ripara, e la caccia inizia", "La mucca si ripara e la lumaca esce"], 
      correct: 2 
    },
    { 
      text: "Di cosa si parla?", 
      choices: ["Di processi clericali", "Di polenta", "Di meteo avverso"], 
      correct: 1 
    }
  ];
  ...
  function showFinalScore() {
    ...
    if (score >= 3) {
      reaction = "WOW, 3 su 3! Sei di Segni?";
    } else if (score == 2) {
      reaction = "Non male, ma non sei davvero del posto!";
    } else {
      reaction = "Il segnino non fa per te...";
    }
