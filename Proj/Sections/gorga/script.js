document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = [
    { 
      text: "Cosa significa?", 
      choices: [
        "La sorte è dalla tua parte", 
        "Hai trovato il tuo scopo", 
        "Sei uscito da una situazione sfortunata"
      ], 
      correct: 0 
    },
    { 
      text: "Cosa vuol dire?", 
      choices: ["La lingua non ha ossa, è molle", "La lingua è fatta per mentire", "La lingua può essere tagliente"], 
      correct: 2 
    },
    { 
      text: "A chi è rivolta questa frase?", 
      choices: ["Al contadino stanco", "A coloro che hanno troppo", "Ai poveri affamati"], 
      correct: 1 
    }
  ];
  ...
  function showFinalScore() {
    ...
    if (score >= 3) {
      reaction = "OTTIMO, 3 su 3! Sei di Gorga?";
    } else if (score == 2) {
      reaction = "Non male, ma non sei davvero del posto!";
    } else {
      reaction = "Il gorgano non fa per te...";
    }
