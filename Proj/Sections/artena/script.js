document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = [
    { 
      text: "Cosa significa?", 
      choices: [
        "Dopo il bello, esce il brutto", 
        "Prima il dovere e poi il piacere", 
        "Dopo il dolce, resta il riposo"
      ], 
      correct: 0 
    },
    { 
      text: "Cosa ha detto?", 
      choices: ["Tu vuoi farmi credere pazzo", "Tu non sei praticante", "Mi stai mentendo"], 
      correct: 2 
    },
    { 
      text: "Chi sono loro?", 
  ...
  function showFinalScore() {
    ...
    if (score >= 3) {
      reaction = "ECCELLENTE, 3 su 3! Sei artenese?";
    } else if (score == 2) {
      reaction = "Non male, ma non sei davvero del posto!";
    } else {
      reaction = "L'artenese non fa per te...";
    }
